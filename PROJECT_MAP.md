...
1. غياب الاختبارات (أكبر دين تقني)
2. عدم وجود `require` في composer.json
3. Magic Numbers غير موثقة
4. كود debug متروك
5. عدم دعم PHP 8.1+ بشكل رسمي
6. God Class يصعب اختباره
