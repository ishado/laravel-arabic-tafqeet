...
trait Calculators
{
    ...
    public function classA(array $arr, int $len = 1): string
    {
        return $this->ones[$arr[0]];
    }

    public function classB(array $arr, int $len = 2): string
    {
    ...
    public function classC(array $arr, int $len = 3): string
    {
    ...
    public function classD(array $arr, int $len = 4): string
    {
    ...
    public function classE(array $arr, int $len = 5): string
    {
    ...
    public function classF(array $arr, int $len = 6): string
    {
    ...
    public function classG(array $arr, int $len = 7): string
    {
    ...
    public function classH(array $arr, int $len = 8): string
    {
    ...
    public function classI(array $arr, int $len = 9): string
    {
