...
trait Handler
{
     ...
     * @return $this
     */
    public function setAmount($number = 0): self
    {
        $this->parsed_number = (string) $number;

        return $this;
    }

    private function split_parsed_number_to_two_number_depend_on_comma(): self
    {
    ...
    private function split_numbers_before_comma_to_array(): self
    {
    ...
    private function split_numbers_after_comma_to_array(): self
    {
